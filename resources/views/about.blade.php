                        ...
                        <div class="flex flex-col gap-6 w-full">
                            ...
                            <div class="flex flex-col items-center gap-2">
                                ...
                                <div class="flex flex-wrap justify-center gap-x-6 gap-y-3">
                                    @foreach(['Moagim', 'MofD)Respect', 'PzH.MT', 'Azoun', 'Sadeff', 'aFF]oOKiVoo[', 'Darkelf-', 'Katerina-CZ', 'Effka[pG]', 'Driver[soasc]', 'fallen.apollyon', 'ALK_aida', 'wiz[WL]ard', 'Super-Nova[TT]', 'GreenGosu'] as $friend)
