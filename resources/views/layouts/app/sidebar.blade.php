                ...
                <flux:sidebar sticky collapsible="mobile"
                    ...
                    <div class="mx-3">
                        <a href="https://ko-fi.com/rankgim" target="_blank"
                            ...
                            <div
                                class="absolute inset-0 bg-white/0 group-hover:bg-white/10 transition-all duration-300">
                            </div>
                            ...
                            <span class="text-white text-xs font-semibold relative z-10 whitespace-nowrap">Help keep
                                Rankgim alive ❤️</span>
                        </a>
                    </div>
                    ...
                    @guest
                    <flux:sidebar.nav>
                        <flux:sidebar.item icon="arrow-left-start-on-rectangle" href="{{ route('login') }}"
                            wire:navigate>
                            {{ __('Login') }}
                        </flux:sidebar.item>
