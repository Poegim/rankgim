        ...
        <div class="mx-3">
            <a href="https://ko-fi.com/rankgim" target="_blank"
               ...
               style="background: linear-gradient(135deg, #ff5e5b 0%, #ff2d55 50%, #d63384 100%);">
                ...
                <svg class="w-4 h-4 text-white shrink-0 relative z-10 group-hover:animate-bounce" viewBox="0 0 24 24" fill="currentColor">
            ...
            <span class="text-white text-xs font-semibold relative z-10 whitespace-nowrap">Help keep Rankgim alive ❤️</span>    </a>
        </div>
