...
<body class="min-h-screen bg-travertine-75 dark:bg-zinc-800">
    ...
    <flux:sidebar sticky collapsible="mobile"
            ...
            <flux:sidebar.item icon="video-camera"
                ...
                <div class="flex items-center justify-between w-full gap-2">
                    ...
                    <span class="inline-flex items-center gap-1 shrink-0">
                        ...
                        {{-- Starred badge: gold star + count.
                             Greyed when 0 (guest or no favorites live). --}}
                        <span
                            class="inline-flex items-center gap-0.5 text-[10px] font-bold px-1.5 py-0.5 rounded-full
                                {{ $starredLiveCount > 0
                                    ? 'bg-amber-500/20 text-amber-300'
                                    : 'bg-travertine-200 text-travertine-400 dark:bg-zinc-800 dark:text-zinc-600' }}"
                            title="{{ auth()->check()
                        ...
                        {{-- Twitch badge — brand color, always white text (rule #6) --}}
                        ...
                        {{-- SOOP badge — brand color, always white text (rule #6) --}}
        ...
        {{-- Theme toggle — wire:persist prevents Livewire from re-initializing
             this on every wire:navigate, which would briefly reset x-model
             to the default value and trigger Flux's applyLight() before
             localStorage is read back. --}}
        <div wire:persist="theme-toggle">
